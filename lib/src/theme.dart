...
class ThemeData {
  ...
  ThemeData({
    ...
    TextStyle body,
    TextStyle button,
  }): this.heading1 = TextStyle(fontSize: 48, color: color, fontFamily: 'Source Code Pro', fontWeight: FontWeight.w300, package: 'funk'),
    this.heading2 = TextStyle(fontSize: 40, color: color, fontFamily: 'Source Code Pro', fontWeight: FontWeight.w300, package: 'funk'),
    this.heading3 = TextStyle(fontSize: 32, color: color, fontFamily: 'Source Code Pro', fontWeight: FontWeight.w300, package: 'funk'),
    this.heading4 = TextStyle(fontSize: 28, color: color, fontFamily: 'Source Code Pro', fontWeight: FontWeight.w300, package: 'funk'),
    this.heading5 = TextStyle(fontSize: 24, color: color, fontFamily: 'Source Code Pro', fontWeight: FontWeight.w300, package: 'funk'),
    this.heading6 = TextStyle(fontSize: 20, color: color, fontFamily: 'Source Code Pro', fontWeight: FontWeight.w300, package: 'funk'),
